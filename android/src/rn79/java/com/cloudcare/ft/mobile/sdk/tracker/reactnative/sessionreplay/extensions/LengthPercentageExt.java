 ...
 */
package com.cloudcare.ft.mobile.sdk.tracker.reactnative.sessionreplay.extensions;
...
public final class LengthPercentageExt {
    ...
    public static float getRadius(LengthPercentage lengthPercentage, float width, float height) {
        ...
        LengthPercentage resolved = lengthPercentage.resolve(width, height);
        if (resolved == null) {
            return 0f;
        }
        
        return (resolved.horizontal + resolved.vertical) / 2f;
    }
} 