package com.cloudcare.ft.mobile.sdk.tracker.reactnative.sessionreplay.utils.text;
...
public class FabricTextViewUtils extends TextViewUtils {
    ...
    private void handleError(Exception e, String message) {
        // TODO: logger.log(InternalLogger.Level.WARN, Arrays.asList(InternalLogger.Target.MAINTAINER, InternalLogger.Target.TELEMETRY), () -> message, e);
    }
} 